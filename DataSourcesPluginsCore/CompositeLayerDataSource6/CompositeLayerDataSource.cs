    ...
    public class CompositeLayerDataSource : IDataSource, ICompositeLayerDataSource
    {
        ...
        public Type GetEntityType(string EntityName)
        {
            ...
            try
            {
                ...
                {
                    // Take the type from the OBJECT this call returns, rather than
                    // reading it off the mutable static that holds the LAST type
                    // built anywhere. A thread resolving a different entity between
