...
{
    public class ChromaDBDataConnection : IDataConnection
    {
        public ChromaDBDataConnection(IDMEEditor dmeEditor)
        {
            DMEEditor = dmeEditor;
        ...
        {
            Logger?.WriteLog("Closing ChromaDB connection");
        ...
        public ConnectionState OpenConnection()
        {
            ...
            {
                DMEEditor?.AddLogMessage("Error", $"Error opening ChromaDB connection: {ex.Message}", DateTime.Now, -1, "", Errors.Failed);
