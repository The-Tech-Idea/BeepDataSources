...
namespace DataManagmentEngineShared.WebAPI
{
    public class WebAPIReader
    {
        ...
        public WebAPIReader(string datasourcename, IDMEEditor pDMEEditor, string databasename, IDataConnection pConn, List<EntityField> pfields)
        {
        ...
        public WebAPIReader(string datasourcename, IDMEEditor pDMEEditor, IDataConnection pConn, List<EntityField> pfields)
        {
        ...
        private async Task<string> GetResponseAsync()
        {
            try
            {
                ...
                return await _client.GetFromJsonAsync<string>(cn.ConnectionProp.Url); 
            }
            catch (Exception ex)
            {
        ...
        {
            ConnProp = DMEEditor.ConfigEditor.DataConnections.FirstOrDefault(c => c.ConnectionName == ConnProp.ConnectionName);
