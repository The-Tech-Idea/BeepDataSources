...
namespace TheTechIdea.Beep.DataSources
{
    ...
    public class HelpScoutDataSource : WebAPIDataSource
    {
        ...
        [CommandAttribute(Category = DatasourceCategory.Connector, DatasourceType = DataSourceType.HelpScout, PointType = EnumPointType.Function, ObjectType = "Conversation", Name = "CreateConversation", Caption = "Create HelpScout Conversation", ClassType = "HelpScoutDataSource", Showin = ShowinType.Both, Order = 10, iconimage = "helpscout.png", misc = "ReturnType: IEnumerable<Conversation>")]
        ...
        [CommandAttribute(Category = DatasourceCategory.Connector, DatasourceType = DataSourceType.HelpScout, PointType = EnumPointType.Function, ObjectType = "Conversation", Name = "UpdateConversation", Caption = "Update HelpScout Conversation", ClassType = "HelpScoutDataSource", Showin = ShowinType.Both, Order = 11, iconimage = "helpscout.png", misc = "ReturnType: IEnumerable<Conversation>")]
