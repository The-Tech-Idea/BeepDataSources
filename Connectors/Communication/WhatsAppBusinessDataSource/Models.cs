...
namespace TheTechIdea.Beep.Connectors.Communication.WhatsAppBusiness.Models
{
    ...
    public sealed class WabaMessageTemplate : WabaEntityBase
    {
        ...
        [JsonPropertyName("components")] public List<WabaTemplateComponent> Components { get; set; } = new();
    }
    ...
    public sealed class WabaTemplateComponent
    {
        ...
        [JsonPropertyName("buttons")] public List<WabaTemplateButton> Buttons { get; set; } = new();
    ...
    public sealed class WabaBusinessProfile : WabaEntityBase
    {
        ...
        [JsonPropertyName("websites")] public List<string> Websites { get; set; } = new();
    }
