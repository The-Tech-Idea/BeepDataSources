...
namespace TheTechIdea.Beep.Connectors.Marketing.Mailchimp
{
    ...
    public class MailchimpDataSource : WebAPIDataSource
    {
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpList), PointType = EnumPointType.Function, Name = "GetLists", Caption = "Get Lists", ClassName = "MailchimpDataSource", misc = "GetLists")]
        public IEnumerable<MailchimpList> GetLists()
        {
            return GetEntity("lists", null).Cast<MailchimpList>();
        }

        [CommandAttribute(ObjectType = nameof(MailchimpCampaign), PointType = EnumPointType.Function, Name = "GetCampaigns", Caption = "Get Campaigns", ClassName = "MailchimpDataSource", misc = "GetCampaigns")]
        public IEnumerable<MailchimpCampaign> GetCampaigns()
        {
            return GetEntity("campaigns", null).Cast<MailchimpCampaign>();
        }

        [CommandAttribute(ObjectType = nameof(MailchimpMember), PointType = EnumPointType.Function, Name = "GetMembers", Caption = "Get Members", ClassName = "MailchimpDataSource", misc = "GetMembers")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpTemplate), PointType = EnumPointType.Function, Name = "GetTemplates", Caption = "Get Templates", ClassName = "MailchimpDataSource", misc = "GetTemplates")]
        public IEnumerable<MailchimpTemplate> GetTemplates()
        {
            return GetEntity("templates", null).Cast<MailchimpTemplate>();
        }

        [CommandAttribute(ObjectType = nameof(MailchimpAutomation), PointType = EnumPointType.Function, Name = "GetAutomations", Caption = "Get Automations", ClassName = "MailchimpDataSource", misc = "GetAutomations")]
        public IEnumerable<MailchimpAutomation> GetAutomations()
        {
            return GetEntity("automations", null).Cast<MailchimpAutomation>();
        }

        [CommandAttribute(ObjectType = nameof(MailchimpReport), PointType = EnumPointType.Function, Name = "GetReports", Caption = "Get Reports", ClassName = "MailchimpDataSource", misc = "GetReports")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpMember), PointType = EnumPointType.Function, Name = "CreateListMember", Caption = "Create List Member", ClassName = "MailchimpDataSource", misc = "CreateListMember")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpMember), PointType = EnumPointType.Function, Name = "UpdateListMember", Caption = "Update List Member", ClassName = "MailchimpDataSource", misc = "UpdateListMember")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpCampaign), PointType = EnumPointType.Function, Name = "CreateCampaign", Caption = "Create Campaign", ClassName = "MailchimpDataSource", misc = "CreateCampaign")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpCampaign), PointType = EnumPointType.Function, Name = "UpdateCampaign", Caption = "Update Campaign", ClassName = "MailchimpDataSource", misc = "UpdateCampaign")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpTemplate), PointType = EnumPointType.Function, Name = "CreateTemplate", Caption = "Create Template", ClassName = "MailchimpDataSource", misc = "CreateTemplate")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpTemplate), PointType = EnumPointType.Function, Name = "UpdateTemplate", Caption = "Update Template", ClassName = "MailchimpDataSource", misc = "UpdateTemplate")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpList), PointType = EnumPointType.Function, Name = "CreateList", Caption = "Create List", ClassName = "MailchimpDataSource", misc = "CreateList")]
        ...
        [CommandAttribute(ObjectType = nameof(MailchimpList), PointType = EnumPointType.Function, Name = "UpdateList", Caption = "Update List", ClassName = "MailchimpDataSource", misc = "UpdateList")]
