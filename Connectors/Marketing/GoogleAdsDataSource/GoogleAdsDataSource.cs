...
namespace TheTechIdea.Beep.Connectors.Marketing.GoogleAds
{
    ...
    public class GoogleAdsDataSource : WebAPIDataSource
    {
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsCustomer), PointType = EnumPointType.Function, Name = "GetCustomers", Caption = "Get Customers", ClassName = "GoogleAdsDataSource", misc = "GetCustomers")]
        public IEnumerable<GoogleAdsCustomer> GetCustomers()
        {
            return GetEntity("customers", null).Cast<GoogleAdsCustomer>();
        }

        [CommandAttribute(ObjectType = nameof(GoogleAdsCampaign), PointType = EnumPointType.Function, Name = "GetCampaigns", Caption = "Get Campaigns", ClassName = "GoogleAdsDataSource", misc = "GetCampaigns")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsAdGroup), PointType = EnumPointType.Function, Name = "GetAdGroups", Caption = "Get Ad Groups", ClassName = "GoogleAdsDataSource", misc = "GetAdGroups")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsAd), PointType = EnumPointType.Function, Name = "GetAds", Caption = "Get Ads", ClassName = "GoogleAdsDataSource", misc = "GetAds")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsKeyword), PointType = EnumPointType.Function, Name = "GetKeywords", Caption = "Get Keywords", ClassName = "GoogleAdsDataSource", misc = "GetKeywords")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsCampaignBudget), PointType = EnumPointType.Function, Name = "GetCampaignBudgets", Caption = "Get Campaign Budgets", ClassName = "GoogleAdsDataSource", misc = "GetCampaignBudgets")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsCampaign), PointType = EnumPointType.Function, Name = "CreateCampaign", Caption = "Create Campaign", ClassName = "GoogleAdsDataSource", misc = "CreateCampaign")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsCampaign), PointType = EnumPointType.Function, Name = "UpdateCampaign", Caption = "Update Campaign", ClassName = "GoogleAdsDataSource", misc = "UpdateCampaign")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsAdGroup), PointType = EnumPointType.Function, Name = "CreateAdGroup", Caption = "Create Ad Group", ClassName = "GoogleAdsDataSource", misc = "CreateAdGroup")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsAdGroup), PointType = EnumPointType.Function, Name = "UpdateAdGroup", Caption = "Update Ad Group", ClassName = "GoogleAdsDataSource", misc = "UpdateAdGroup")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsAd), PointType = EnumPointType.Function, Name = "CreateAd", Caption = "Create Ad", ClassName = "GoogleAdsDataSource", misc = "CreateAd")]
        ...
        [CommandAttribute(ObjectType = nameof(GoogleAdsAd), PointType = EnumPointType.Function, Name = "UpdateAd", Caption = "Update Ad", ClassName = "GoogleAdsDataSource", misc = "UpdateAd")]
